...
var QSign = (() => {
  ...
  // node_modules/@qubic-lib/qubic-ts-library/dist/crypto/libFourQ_K12.js
  var require_libFourQ_K12 = __commonJS({
    "node_modules/@qubic-lib/qubic-ts-library/dist/crypto/libFourQ_K12.js"(exports) {
      "use strict";
  ...
  // node_modules/@qubic-lib/qubic-ts-library/dist/crypto/keccakp.js
  var require_keccakp = __commonJS({
    "node_modules/@qubic-lib/qubic-ts-library/dist/crypto/keccakp.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/@qubic-lib/qubic-ts-library/dist/crypto/index.js
  var require_crypto = __commonJS({
    "node_modules/@qubic-lib/qubic-ts-library/dist/crypto/index.js"(exports) {
      "use strict";
      ...
      var libFourQ_K12_js_1 = __importDefault(require_libFourQ_K12());
      var keccakp_js_1 = require_keccakp();
      ...
      crypto2.keccakP160012 = keccakp_js_1.keccakP160012;
  ...
  // node_modules/@qubic-lib/qubic-ts-library/dist/keyHelper.js
  var require_keyHelper = __commonJS({
    "node_modules/@qubic-lib/qubic-ts-library/dist/keyHelper.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.KeyHelper = void 0;
      var KeyHelper2 = class {
        constructor() {
      ...
      exports.KeyHelper = KeyHelper2;
      KeyHelper2.getIdentityBytes = function(identity) {
  ...
  // src/browser/qsign.ts
  var qsign_exports = {};
  __export(qsign_exports, {
    clear: () => clear,
    init: () => init,
    isReady: () => isReady,
  ...
  var import_keyHelper = __toESM(require_keyHelper());
  async function privateKeyFromSeed(seed) {
    const { K12 } = await import_crypto.default;
    const kh = new import_keyHelper.KeyHelper();
    return kh.privateKey(seed, 0, K12);
  }
  async function publicKeyFromPrivate(privateKey) {
    const { schnorrq } = await import_crypto.default;
    return schnorrq.generatePublicKey(privateKey);
  }
  function buildRawMessage(tokenHex, nonceHex, timestampMs) {
  ...
  async function buildDigest(raw) {
    const { K12 } = await import_crypto.default;
  ...
  async function signedHeaders(tokenHex) {
    if (!state)
      throw new Error("QSign not initialized \u2014 call QSign.init(seed) first");
    const { schnorrq } = await import_crypto2.default;
  ...
  return __toCommonJS(qsign_exports);
})();
